 ...
 */
@Component // I am a candidate for autowiring in other classes
public class PersonService {
    ...
    public Person update(Long id, Person newPersonData) {
        ...
        personInDb.setPersonalMetaData(newPersonData.getPersonalMetaData());
        personInDb.setLicenseMetaData(newPersonData.getLicenseMetaData());
